...
//InsertObject($conn,"obj-button", "Room Light", 0, "flavor-blue", 30, "fa-lightbulb-o");
//InsertObject($conn,"obj-button", "Fan", 0, "flavor-blue", 30, "fa-life-bouy");
...
//  DeleteObject($conn, "Fan");
//DeleteObject($conn, "Room Light");
